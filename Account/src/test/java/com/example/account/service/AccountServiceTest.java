...
class AccountServiceTest {
    ...
    void testXXX() {
        ...
        //then
        verify(accountRepository, times(1)).findById(captor.capture()); //한 번 호출
        verify(accountRepository, times(0)).save(any()); //저장하면 안되는 경우
    ...
    void testFailedToSearchAccount() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> accountService.getAccount(-10L));//여기를 동작시키면 RuntimeException 발생 할 것이다
