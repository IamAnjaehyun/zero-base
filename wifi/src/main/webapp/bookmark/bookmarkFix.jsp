...
<table>
    ...
    <form action="bookmarkGroup.jsp" method="post">
        ...
        <tr>
            <td colspan="2">
                <a href="bookmarkGroup.jsp">돌아가기</a> | <input
                    onclick="<%=bookmarkService.fixBookmark(request.getParameter("name"), Integer.parseInt(request.getParameter("order")))%>; location.href='bookmarkGroup.jsp';"
